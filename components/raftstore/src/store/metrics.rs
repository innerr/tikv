...
lazy_static! {
    pub static ref STORE_LOOP_DURATION_HISTOGRAM: Histogram =
        register_histogram!(
            ...
            "TODO",
            exponential_buckets(0.0005, 1.4143, 40).unwrap()
        ).unwrap();
